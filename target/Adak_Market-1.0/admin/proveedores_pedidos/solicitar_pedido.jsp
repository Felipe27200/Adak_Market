    ...
    <div class="col-md-9 ">
        <form class="font-weight-bold">
            <div class="form-group text-center mt-4">
                <img src="../../img/Proveedores/LOGO_PEDIDOS.png" class="img-fluid" style="width: 7%;" alt="">
                <p style="font-size: 25px;">Solicitar Pedido </p>
            </div>
            ...
            <button type="submit" class="btn btn-success btn-block"  name="btnGrabar" id="btnregistrarPedido" >Solicitar</button>
        </form>	
        <%
            if (request.getParameter("btnGrabar") != null) {

                String nompro = request.getParameter("nombre_producto");
                String mar = request.getParameter("marca");
                String cant = request.getParameter("cantidad");
                String fecha_entre = request.getParameter("fecha_entrega");
                String direc = request.getParameter("direccion");
                String pagi = request.getParameter("pagina_web");
                ...
                try {
                    ...
                    sta.executeUpdate("insert into pedidos(nombre_producto,marca,cantidad,fecha_entrega,direccion,pagina_web) values('" + nompro + "','" + mar + "','" + cant + "','" + fecha_entre + "','" + direc + "','" + pagi + "')");
