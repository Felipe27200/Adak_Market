<%-- 
    Document   : reporteAgenda
    Created on : 19/05/2021, 10:23:02 AM
    Author     : felip
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-9 mt-4">
                    <div class="row ">
                        <div class="col">
                            <h1 class="display-4">Reporte Agenda Empleado</h1>
                        </div>
                    </div>
                    ...
                    <div class="row pt-5">
                        <div class="col-lg-6 col-md text-center">
                            <h3>Novedades</h3>
                            <canvas id="novedades"></canvas>
                        </div>
                        <div class="col-lg-6 col-md text-center">
                            <h3>Horas de trabajo de la última semana</h3>
        ...
        <script type="text/javascript" src="../../graficas/graficasAgenda.js"></script>
