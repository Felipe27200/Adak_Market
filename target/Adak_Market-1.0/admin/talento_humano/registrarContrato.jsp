            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <%
                        ...
                        //if (request.getAttribute("identificacion") != null)
                        //{
                        //    documento = (String) request.getAttribute("identificacion");
                        //}
                        ...
                        try {
                            ...
                            sta.executeUpdate("INSERT INTO contratos (id_usuario) VALUE('"+request.getAttribute("identificacion")+"')");
                            rs = sta.executeQuery("SELECT cont.nombre_empleador, us.nombre, cont.dir_establecimiento, cont.ciudad_establecimiento, us.cargo, cont.fecha_inicio, cont.objeto_contrato, us.id_usuario FROM contratos AS cont INNER JOIN USUARIOS AS us ON us.id_usuario = cont.id_usuario WHERE us.id_usuario = '"+request.getAttribute("identificacion")+"'");
                    ...
                    <form class="font-weight-bold" id="formularioContrato" onsubmit="return validarContrato();">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" value="<%=rs.getString(1)%>" name="nombreEmpleador" id="nombreEmpleador" required="">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputPassword4">Nombre del empleado</label>
                                <input type="text" class="form-control" value="<%=rs.getString(2)%>" name="nombreEmpleado" id="nombreEmpleado" disabled required="">
                            </div>
                        </div>							  
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="number" name="identificacion" class="form-control" value="<%=rs.getString(8)%>" readonly="readonly">
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" name="direccionEstablecimiento" id="direccionEstablecimiento" required="" value="<%=rs.getString(3)%>">
                            </div>

                            <div class="form-group col-md-3">
                                <label for="">Ciudad dónde está el establecimiento</label>
                                <input type="text" class="form-control" name="ciudadEstablecimiento" id="ciudadEstablecimiento" required="" value="<%=rs.getString(4)%>">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input name="fechaInicio" value="<%=rs.getString(6)%>" type="date" class="form-control" required="">
                            </div>

                            <div class="form-group col-md-3">
                                <fieldset class="form-group row justify-content-around">
                                    <legend class="col-form-label col-md-7 float-sm-left pt-0">El contrato es definido?</legend>
                                    <div class="col-md-5">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="duracionContrato" id="duracionContrato" placeholder="si es indefinido digite cero" class="form-control" required="">
                            </div>

                            <div class="form-group col-md-5">
                                <label for="message-text" class="col-form-label">Objeto del contrato (labor a desempeñar):</label>
                                <textarea value="" class="form-control" name="objetoContrato" id="message-text" required=""><%=rs.getString(7)%></textarea>
                            </div>	
                        </div>
