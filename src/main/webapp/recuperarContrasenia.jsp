        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-around mt-5 pt-5">
                <div class="col-lg-4 col-md-6 col-sm-8 color1">
                    ...
                    <form class="font-weight-bold pb-3" action="<%=request.getContextPath()%>/SendMail?accion=recuperar" method="POST" onsubmit="return validarUsuario();">
                        <div class="form-group mt-3">
                            <label for="">Ingrese su No. de Documento</label>
                            <input type="number" id="identificacion" name="id_usuario" class="form-control" required>
                        </div>
