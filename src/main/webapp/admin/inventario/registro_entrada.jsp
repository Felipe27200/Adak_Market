                ...
                <div class="col-md-9">
                    ...
                    <form class="font-weight-bold">
                        ...
                        <div class="form-row justify-content-center">
                            ...
                            <div class="form-group col-sm-8">
                                <label for="precio del producto">Fecha Entrada</label>
                                <input type="date" class="form-control form-control-sm" name="fecha_entrada" id="fecha_salida"  required>
                            </div>

                            <div class="form-group col-sm-8">
                                <label for="cantidad">cantidad</label>
                                <input type="number" class="form-control form-control-sm" name="cantidad" id="cantidad"  minlength="1" required>
                            </div>
                            
                            
                            <div class="form-group col-sm-8">
                                <button type="submit" name="btnRegistrar" value="Registrar Entrada" class="btn btn-block btn-success mt-3 mb-3">Registrar</button>
                            </div>
                        ...
                        if (request.getParameter("btnRegistrar") != null) {
                           ...
                           int codigo = Integer.parseInt(request.getParameter("codigo"));
                            String fechaE = request.getParameter("fecha_entrada");
                            String cant = request.getParameter("cantidad");
                         
                            

                            sta.execute("UPDATE productos SET fecha_entrada='"+fechaE+"',cantidad='"+cant+"' WHERE codigo='"+codigo+"'");
                                Conexion.close(rs);
                                Conexion.close(sta);
                                Conexion.close(cnx);
