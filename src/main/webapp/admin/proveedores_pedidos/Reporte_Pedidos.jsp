			...
			<div class="col-md-3">
				<nav id="Menu" class="d-md-block collapse bg-light navbar-light pl-4">
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item"><a href="Reporte_Proveedores.jsp" class="nav-link"><i class="far fa-address-card"></i>Generar Reporte</a></li>
					</ul>
                    <div class="navTitulo">
			...
			<div class="col-md-9 mt-4">
                ...
                <div class="row">
                    <div class="col text-center mt-3 mb-3">
                        <a href="../proveedores_pedidos/Reportes.jsp" class="btn btn-success col-lg-3 col-md-5">Gráficas Reporte</a>
                    </div>
                </div>
